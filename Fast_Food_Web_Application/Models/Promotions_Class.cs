    ...
    public class Promotions_Class
    {
        ...
        public IList<tbl_product_Class> getImages()
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.CommandText = "select pro_Food_id,pro_FoodName,pro_FoodDescription,pro_FoodPrice,pro_FoodImage from tbl_product where pro_dealsName LIKE '%PROMOTION%'";
                sqlcon.Open();
